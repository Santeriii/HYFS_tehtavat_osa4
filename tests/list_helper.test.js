...
describe('total likes', () => {
    ...
    test('when list has no blogs the likes equal 0', () => {
    ...
    test('when list has multiple blogs the likes equal the expected sum', () => {
...
describe('most likes', () => {
    ...
    test('author with the most likes on blogs is returned', () => {
        result = {
            author: "Edsger W. Dijkstra",
            likes: 17
        }
